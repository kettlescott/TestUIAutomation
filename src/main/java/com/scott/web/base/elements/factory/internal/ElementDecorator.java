package com.scott.web.base.elements.factory.internal;
 ...
 *
 * <p>It is designed to support and return concrete implementations of wrappers for a variety of
...
public class ElementDecorator implements FieldDecorator {
   ...
   */
  protected <T> T proxyForLocator(
      ClassLoader loader, Class<T> interfaceType, ElementLocator locator) {
    ...
    proxy =
        interfaceType.cast(
            Proxy.newProxyInstance(
                loader,
                new Class[] {interfaceType, WebElement.class, WrapsElement.class, Locatable.class},
                handler));
    return proxy;
  }
  ...
  protected <T> List<T> proxyForListLocator(
      ClassLoader loader, Class<T> interfaceType, ElementLocator locator) {
