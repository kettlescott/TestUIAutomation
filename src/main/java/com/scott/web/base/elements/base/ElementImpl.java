...
import com.scott.web.base.elements.utils.FoundBy;
import com.scott.web.base.elements.utils.Locator;
import com.scott.web.base.elements.utils.Util;
...
/**
 * An implementation of the Element interface. Delegates its work to an underlying WebElement
 * instance for custom functionality.
 */
public class ElementImpl implements Element {
  ...
  public void clickUsingJs() {
    ...
    executor.executeScript("arguments[0].click();", getWrappedElement());
  }
  ...
  public <T> T findElement(By by, Class<?> c, boolean refreshParent) {
    try {
      if (refreshParent) {
        ...
        return (T)
            c.getConstructor(WebElement.class).newInstance(getWrappedElement().findElement(by));
      }
